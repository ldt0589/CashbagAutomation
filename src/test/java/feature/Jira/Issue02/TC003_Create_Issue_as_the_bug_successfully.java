...
public class TC003_Create_Issue_as_the_bug_successfully extends TestBase {
    ...
    @Test(groups = {"Smoke"}, dataProvider = "getDataForTest", priority = 1, description = "Create an Issue on Jira")
