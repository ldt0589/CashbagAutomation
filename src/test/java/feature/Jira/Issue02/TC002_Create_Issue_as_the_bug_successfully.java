...
public class TC002_Create_Issue_as_the_bug_successfully extends TestBase {
    ...
    @Test(groups = {"Regression"}, dataProvider = "getDataForTest", priority = 1, description = "Create an Issue on Jira")
